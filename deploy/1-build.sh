...
rebuild_cron_image ${METRICSPRECALCULATION_IMAGE} ${METRICSPRECALCULATION_APP_NAME} "c0c38604c0c38604c0c386040ec0b1ee86cc0c3c0c386049e1b271652a7aa263de9d3f6"
rebuild_cron_image ${ANALYTICSPRECALCULATION_IMAGE} ${ANALYTICSPRECALCULATION_APP_NAME} "c0c38604c0c38604c0c386040ec0b1ee86cc0c3c0c386049e1b271652a7aa263de9d3f6"
rebuild_cron_image ${POSTCOLLECTOR_IMAGE} ${POSTCOLLECTOR_APP_NAME} "cc6370c3cc6370c3cc6370c31ccc111843ccc63cc6370c392bbd0d914bc03f1c875edee"
rebuild_cron_image ${POSTACTUALIZER_IMAGE} ${POSTACTUALIZER_APP_NAME} "50d69ba050d69ba050d69ba05c50a4f321550d650d69ba00e0e3aa614ef8be8834396c6"
rebuild_cron_image ${USEDATACOLLECTOR_IMAGE} ${USEDATACOLLECTOR_APP_NAME} "c0c38604c0c38604c0c386040ec0b1ee86cc0c3c0c386049e1b271652a7aa263de9d3f6"